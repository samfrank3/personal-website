    ...
    return (
        <div className="accordion-section">
            <button className={`accordion ${setActive}`} onClick={toggleAccordion}>
                ...
                <div className='accordion-club'><span className="title">{props.club}</span></div>
                <div className="accordion-title"><span className="title">{props.title}</span><Icon className={`${setRotate}`} icon="mdi:chevron-right" width="2em"/></div>
            </button>
